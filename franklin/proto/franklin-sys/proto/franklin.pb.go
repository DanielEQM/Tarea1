...
const file_franklin_proto_rawDesc = "" +
	...
	"\fconfirmacion\x18\x01 \x01(\bR\fconfirmacion2S\n" +
	"\aMission\x12H\n" +
	"\vDistraccion\x12\x1b.mensaje.DistraccionRequest\x1a\x1c.mensaje.DistraccionResponseB\x14Z\x12franklin-sys/protob\x06proto3"
...
var file_franklin_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_franklin_proto_depIdxs = []int32{
	...
	1, // 1: mensaje.Mission.Distraccion:output_type -> mensaje.DistraccionResponse
