...
const file_lester_proto_rawDesc = "" +
	...
	"\x03msj\x18\x01 \x01(\tR\x03msj2\xd6\x02\n" +
	"\aMission\x12;\n" +
	...
	"\x10ConfirmacionPago\x12\x14.mensaje.PagoRequest\x1a\x15.mensaje.PagoResponseB\x12Z\x10lester-sys/protob\x06proto3"
...
var file_lester_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_lester_proto_goTypes = []any{
	...
	(*PagoRequest)(nil),     // 6: mensaje.PagoRequest
	(*PagoResponse)(nil),    // 7: mensaje.PagoResponse
}
var file_lester_proto_depIdxs = []int32{
	...
	6, // 4: mensaje.Mission.ConfirmacionPago:input_type -> mensaje.PagoRequest
	3, // 5: mensaje.Mission.Oferta:output_type -> mensaje.MissionResponse
	5, // 6: mensaje.Mission.ConfirmMission:output_type -> mensaje.ConfirmResponse
	1, // 7: mensaje.Mission.NotificarEstrellas:output_type -> mensaje.AvisoResponse
	5, // 8: mensaje.Mission.NotificarGolpe:output_type -> mensaje.ConfirmResponse
	7, // 9: mensaje.Mission.ConfirmacionPago:output_type -> mensaje.PagoResponse
